#import "DawnTranslationListController.h"
@implementation DawnTranslationListController
...
-(NSString *)locale:(PSSpecifier *)specifier {
    return [[NSLocale currentLocale] localizedStringForLocaleIdentifier:specifier.properties[@"localeID"]];
}
